/* CS261- Assignment 2 - testDynArray.c*/
/* Name: Corey Hemphill
 * Date: 10/16/2015
...
//    printf("\n\nTesting dynArrSetCapacity...\nCalling dynArrSetCapacity(dyn, 10)\n");
//    dynArrSetCapacity(dyn, 10);
//    addDynArr(dyn, 12);
//    addDynArr(dyn, 8);
//    addDynArr(dyn, 7);
//    addDynArr(dyn, 11);
//    addDynArr(dyn, 9);
//    printf("The array's content: [3,6,5,7,12,8,7,11,9]\n");
//    assertTrue(EQ(getDynArr(dyn, 6), 11), "Test 7th element == 11");
//    assertTrue(EQ(getDynArr(dyn, 7), 9), "Test 8th element == 9");
//    assertTrue(EQ(capDynArr(dyn), 10), "Test capacity = 10");
